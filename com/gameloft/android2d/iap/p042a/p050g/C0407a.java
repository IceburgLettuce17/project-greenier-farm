...
public final class C0407a extends AbstractC0358a {
    public static C0407a acl = null;

    public C0407a() {
        this.f2744Zq = "wap_pp";
    }

    private static String m2362bX(String str) {
        ...
        if (C0491r.m2682tg() != 0) {
            C0012k.m41c("IAP-PayPalBilling", "TimeStamp request failed");
            return null;
        }
        String m2689tt = C0491r.m2689tt();
        C0012k.m41c("IAP-PayPalBilling", "TimeStamp request success = " + m2689tt);
        return m2689tt;
    }

    @Override
    public final void mo2253bp(String str) {
        C0012k.m41c("IAP-PayPalBilling", "PayPalBilling an item");
        try {
            acl = this;
            String str2 = this.url;
            String m2362bX = m2362bX(str2);
            if (m2362bX == null) {
                C0463b.setResult(3);
                C0463b.m2521eV(-1);
            } else {
                String substring = m2362bX.substring(2, m2362bX.length() - 2);
                C0491r.m2681tf();
                ...
                ((Activity) C0488o.getContext()).runOnUiThread(new C0408b(this, str2, property, str, m2649cJ, m2530qC, hashMap));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public final void mo2267rE() {
        C0012k.m41c("IAP-PayPalBilling", "######################### VerificationBilling ##################");
        ...
        C0012k.m41c("IAP-PayPalBilling", "Verification in process: https://secure.gameloft.com/freemium/wapbilling/validate.php?" + str);
        ...
        if (C0491r.m2682tg() == 0) {
            C0463b.m2552qY();
            C0463b.setResult(7);
            C0012k.m41c("IAP-PayPalBilling", "Verification successed!!!!!!!!!!!!!!!!!!!");
            C0012k.m41c("IAP-PayPalBilling", "Purchase successed!!!!!!!!!!!!!!!!!!!!!!!");
            C0414f.m2382cq("");
            C0414f.m2379cn(new StringBuilder().append(C0463b.m2554qz()).toString());
            C0012k.m41c("IAP-PayPalBilling", "Saved Pending Transaction Result: " + C0463b.m2554qz());
            return;
        }
        C0463b.setResult(3);
        ...
        C0414f.m2382cq("");
        C0414f.m2379cn("");
        C0012k.m41c("IAP-PayPalBilling", "Verification failed!!!!!!!!!!!!!!!!!!!");
    }

    @Override
    public final boolean mo2268rF() {
        String m2400sn = C0414f.m2400sn();
        C0012k.m41c("IAP-PayPalBilling", "[isPendingVerificationBilling] wapPurchaseId: " + m2400sn);
        return (m2400sn == null || m2400sn.equals("")) ? false : true;
    }

    @Override
    public final boolean mo2269rG() {
        C0012k.m41c("IAP-PayPalBilling", "[isPendingTransaction]" + C0414f.m2396sj());
