...
final class C0453h extends Thread {
    private C0446a adF;

    C0453h(C0446a c0446a) {
        this.adF = c0446a;
    }
    ...
    public final void run() {
        ...
        String str3;
        String str4;
        C0012k.m41c("IAP-UMPBilling", "sendMO1: new thread started");
        try {
            ...
            C0463b.setResult(3);
            C0463b.m2521eV(-1);
            C0012k.m41c("IAP-UMPBilling", "sendMO1: SMS sent failed! Exception: " + th.toString());
        }
        if (!bq) {
        ...
        PendingIntent broadcast = PendingIntent.getBroadcast(C0488o.getContext(), 0, new Intent("MO1_SENT"), 0);
        C0488o.getContext().registerReceiver(new C0458m(this.adF), new IntentFilter("MO1_SENT"));
        SmsManager smsManager = SmsManager.getDefault();
        str3 = this.adF.ady;
        str4 = this.adF.adA;
        smsManager.sendTextMessage(str3, null, str4, broadcast, null);
        C0012k.m41c("IAP-UMPBilling", "sendMO1: sendTextMessage done!");
        C0463b.m2500ad(false);
        C0012k.m41c("IAP-UMPBilling", "sendMO1: SMS Thread ended!");
    }
}
